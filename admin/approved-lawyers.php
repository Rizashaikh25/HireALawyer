                ...
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        ...
                        <ol class="breadcrumb float-right mt-3">
                            ...
                            <li class="breadcrumb-item active">Approved Lawyers</li>
                        </ol>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover display" style="width:100%" id="myTable">
                        ...
                        <?php
                        $query = mysqli_query($con, "select * from lawyer where status = 'Approved' ORDER BY id DESC");
                        $cnt = 1;
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ("" == $row['lawyer_email'] || "" == $row['lawyer_password'] || "" == $row['lawyer_number']) {
                                $stat = "No";
                            } else {
                                $stat = "Yes";
                            }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" class="delete_btn_ajax"><i class="fas fa-trash icon-del"></i>
                                        <!-- <a 
                                        href="actions/delete-lawyer.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?');">
                                        <i class="fas fa-trash icon-del"></i> -->
                                    </a>
                                </td>
                                <span class="btn-label btn-label-right btn-sm">
                                    <td><a role="button" href="edit-lawyer?id=<?php echo $row['id']; ?>" class="btn btn-success ">

        ...
        <div class="col-md-offset-4 col-md-4">
          ...
          <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="form-group">
              ...
              <input type="text" name="admin_username" class="form-control" placeholder="" required>
            </div>
            <div class="form-group">
          ...
          if (isset($_POST['login'])) {
            ...
            if (empty($_POST['admin_username']) || empty($_POST['password'])) {
              ...
              $sql = "SELECT id, admin_username FROM admin WHERE admin_username = '{$admin_username}' AND password= '{$password}'";

                ...
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        ...
                        <ol class="breadcrumb float-right mt-3">
                            ...
                            <li class="breadcrumb-item active">Featured Lawyers</li>
                        </ol>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover display" style="width:100%" id="myTable">
                        ...
                        <?php
                        $query = mysqli_query($con, "select * from lawyer where status = 'Featured' ORDER BY id DESC");
                        $cnt = 1;
